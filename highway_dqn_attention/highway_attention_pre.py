...
class my_env(gym.Env):
    ...
    def __init__(self, config):
        ...
        self.tot_step = 0  # 总步数
        self.env = gym.make("highway-fast-v0")  # 创建了一个HighwayEnvFast(HighwayEnv)实例，详情见highway_env
...
def baseline_train(config):
    ...
    # tensorboard --logdir="C:\Users\28063\Desktop\xhs\highway_dqn_attention\highway_com"
    model.learn(total_timesteps=int(8e5), n_eval_episodes=20)
    model.save("model/highway_dqn_rnn/dqn_model_attention3e5")  # 32
