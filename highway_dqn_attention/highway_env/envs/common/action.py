...
class DiscreteMetaAction(ActionType):
    ...
    def __init__(self,
        ...
        self.low_controller_type = kwargs.get("low_level", "PID")
    ...
    @property
    def vehicle_class(self) -> Callable:
        return functools.partial(MDPVehicle, target_speeds=self.target_speeds, low_controller=self.low_controller_type)
