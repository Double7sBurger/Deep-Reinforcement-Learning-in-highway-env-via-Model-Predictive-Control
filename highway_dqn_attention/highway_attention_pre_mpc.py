...
def baseline_train(config):
    ...
    # tensorboard --logdir="accomplish\highway_dqn_attention\tensorboard\highway_com"
    for i in range (5):
        model.learn(total_timesteps=int(1000), reset_num_timesteps=False, n_eval_episodes=20)
        model.save("model/highway/YukangHu/timesteps5000")  # 32
